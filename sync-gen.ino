...
#define US_PER_KHZ 1000

// macros
#define KHZ_TO_USEC(khz) (1 / khz * US_PER_KHZ)
...
#define NTSC_HSYNC_PERIOD_TICKS USEC_TO_TICKS(NTSC_HSYNC_PERIOD_US)
#define NTSC_VSYNC_PERIOD_TICKS USEC_TO_TICKS(NTSC_VSYNC_PERIOD_US)
#define NTSC_ACTIVE_VIDEO_DELAY_TICKS USEC_TO_TICKS(NTSC_HSYNC_PERIOD_US + NTSC_BACK_PORCH_PERIOD_US)
